...
urls = [f"/home/andrew/data/b_krosh_winning/00{i}.png" for i in range(33,41)]
...
images = pipeline(prompt_ids, params, prng_seed, bias_instance_images, [.01,.03,.04,.05], num_inference_steps, jit=True).images
...
g.save("generated/winning_a_game_on_one_krosh.jpg")