...
weights_list  = [[.4,.4,.4,.4],[.2,.2,.2,.2],[.25,.35,.45,.55],[.3,.3,.3,.3]]
...
for prompt_idx, prompt in enumerate(prompts):
    ...
    num_inference_steps = 1000 # CHANGE:ITERSTEP IF YOU CHANGE THIS, ALSO CHAGNE THE BIAS FACTOR DEGENERATION
    ...
    save_dir = f"generated/mansion/{character_name}_{num_inference_steps}_{layer_bias_factors}_{prompt_idx:02d}{prompt[0]}.jpg"
    g.save(save_dir)
