...
class FlaxInfusionUNetModel(nn.Module, FlaxModelMixin, ConfigMixin):
    ...
    def __call__(
        ...
        biasList: List[jnp.ndarray] = None,
        ...
        """
        biasses_is_none = biasList is None
        #if(not biasses_is_none):
        #    biasList = jnp.
        ...
        if not return_dict:
            return (sample,biasList)

        return FlaxUNet2DConditionOutput(sample=sample, biasList=biasList)